...
@group(0) @binding(0) 
var<storage, read_write> vram16_: VRAM16_;
@group(1) @binding(6) 
...
fn load_vram_color(index: ptr<function, u32>, slice: u32) {
    ...
    let _e74 = (*index);
    let _e75 = slice_1;
    (*index) = (_e74 + (_e75 * 4194304u));
    let _e79 = (*index);
    let _e86 = vram16_.data[((_e79 ^ 1u) >> 1u)];
    let _e87 = (*index);
    word = ((_e86 >> (((_e87 ^ 1u) & 1u) * 16u)) & 65535u);
    let _e98 = word;
    let _e101 = word;
    let _e104 = word;
    rgb = (vec3<u32>((_e98 >> 8u), (_e101 >> 3u), (_e104 << 2u)) & vec3(248u));
    let _e112 = rgb;
    let _e113 = vec3<i32>(_e112);
    let _e114 = (*index);
    let _e119 = hidden_vram.data[(_e114 >> 2u)];
    let _e120 = (*index);
    let _e132 = word;
    current_color = vec4<i32>(_e113.x, _e113.y, _e113.z, ((i32(((_e119 >> ((_e120 & 3u) * 8u)) & 255u)) << 5u) | i32(((_e132 & 1u) << 7u))));
    return;
}
...
fn convert_rgba16_(word_11: u32) -> vec4<i32> {
    ...
    word_12 = word_11;
    let _e70 = word_12;
    rgb_1 = ((vec3(_e70) >> vec3<u32>(11u, 6u, 1u)) & vec3(31u));
    let _e81 = rgb_1;
    let _e85 = rgb_1;
    rgb_1 = ((_e81 << vec3(3u)) | (_e85 >> vec3(2u)));
    let _e90 = word_12;
...
fn decode_memory_color(image_read_en: bool) -> vec4<i32> {
    ...
    let _e79 = current_color;
    color_6 = (_e79.xyz & vec3(248i));
    let _e85 = color_6;
    let _e86 = memory_coverage;
    return vec4<i32>(_e85.x, _e85.y, _e85.z, _e86);
}
...
fn rgb_dither_1(orig_rgb: vec3<i32>, dith: i32) -> vec3<i32> {
    ...
    let _e87 = orig_rgb_1;
    let _e96 = orig_rgb_1;
    rgb_2 = select(((_e87 & vec3(248i)) + vec3(8i)), vec3(255i), (_e96 > vec3(247i)));
...
fn copy_pipeline(word_17: u32, primitive_index_4: u32) {
    ...
    let _e103 = b_2;
    let _e105 = a_2;
    param_21 = vec4<i32>(i32(_e99), i32(_e101), i32(_e103), i32(_e105));
    let _e109 = param_21;
    write_color(_e109);
    return;
}

fn fill_color(col_2: ptr<function, u32>) {
    var r_2: u32;
    var g_2: u32;
    var b_3: u32;
    var a_3: u32;
    var param_22: vec4<i32>;

    let _e69 = (*col_2);
    let _e70 = color_fb_index;
    (*col_2) = (_e69 >> (((_e70 & 1u) ^ 1u) * 16u));
    let _e78 = (*col_2);
    r_2 = ((_e78 >> 8u) & 248u);
    let _e84 = (*col_2);
    g_2 = ((_e84 >> 3u) & 248u);
    ...
    let _e106 = b_3;
    let _e108 = a_3;
    param_22 = vec4<i32>(i32(_e102), i32(_e104), i32(_e106), i32(_e108));
    let _e112 = param_22;
    write_color(_e112);
    return;
}
...
fn store_vram_color(index_30: ptr<function, u32>, slice_5: u32) {
    ...
    if _e71 {
        {
            let _e72 = (*index_30);
            (*index_30) = (_e72 & 4194303u);
            let _e75 = (*index_30);
            let _e76 = slice_6;
            (*index_30) = (_e75 + (_e76 * 4194304u));
            let _e80 = current_color;
            c_1 = vec4<u32>(_e80);
            let _e83 = c_1;
            _2013_ = _e83;
            let _e85 = _2013_;
            _2016_ = (_e85.xyz & vec3(248u));
            let _e92 = _2016_;
            c_1.x = _e92.x;
            let _e95 = _2016_;
            c_1.y = _e95.y;
            ...
            let _e114 = c_1;
            let _e119 = cov;
            word_19 = ((((_e105.x << 8u) | (_e109.y << 3u)) | (_e114.z >> 2u)) | (_e119 >> 2u));
            let _e124 = (*index_30);
            let _e131 = (*index_30);
            let _e138 = vram16_.data[((_e131 ^ 1u) >> 1u)];
            let _e140 = (*index_30);
            let _e150 = word_19;
            let _e153 = (*index_30);
            vram16_.data[((_e124 ^ 1u) >> 1u)] = ((_e138 & ~((65535u << (((_e140 ^ 1u) & 1u) * 16u)))) | ((_e150 & 65535u) << (((_e153 ^ 1u) & 1u) * 16u)));
            let _e162 = (*index_30);
            let _e167 = (*index_30);
            let _e172 = hidden_vram.data[(_e167 >> 2u)];
            let _e174 = (*index_30);
            let _e182 = cov;
            let _e187 = (*index_30);
            hidden_vram.data[(_e162 >> 2u)] = ((_e172 & ~((255u << ((_e174 & 3u) * 8u)))) | (((_e182 & 3u) & 255u) << ((_e187 & 3u) * 8u)));
            return;
        }
    } else {
        return;
    ...
    if _e71 {
        {
            ...
            let _e93 = current_dz;
            vram16_.data[(_e80 ^ 1u)] = (u32((u32((_e85 << 2u)) & 65535u)) | u32((_e93 >> 2u)));
            let _e99 = (*index_31);
            let _e104 = (*index_31);
...
fn finish_tile(coord_3: ptr<function, vec2<u32>>, fb_width_2: u32, fb_height_2: u32, fb_addr_index_2: u32, fb_depth_addr_index_2: u32) {
    ...
    store_vram_color((&param_23), _e124);
...
fn main_1() {
    ...
    let _e125 = param_4_8;
    init_tile((&param_24), _e122, _e123, _e124, _e125);
    loop {
                            ...
                            if ((_e190.coverage_count & 64i) != 0i) {
                                {
                                    ...
                                    param_9_7 = _e203;
                                    fill_color((&param_9_7));
                                }
                            } else {
                                {
                                    let _e207 = shaded_3;
                                    if ((_e207.coverage_count & 32i) != 0i) {
                                        {
                                            let _e213 = shaded_3;
                                            param_10_6 = u32(_e213.z_dith);
                                            let _e217 = primitive_index_6;
                                            param_11_6 = _e217;
                                            let _e219 = param_10_6;
                                            let _e220 = param_11_6;
                                            copy_pipeline(_e219, _e220);
                                        }
                                    } else {
                                        {
                                            let _e221 = x_12;
                                            ...
                                            let _e223 = y_8;
                                            param_13_6 = _e223;
                                            let _e225 = primitive_index_6;
                                            param_14_6 = _e225;
                                            let _e227 = shaded_3;
                                            param_15_6 = _e227;
                                            let _e229 = param_12_6;
                                            let _e230 = param_13_6;
                                            let _e231 = param_14_6;
                                            let _e232 = param_15_6;
                                            depth_blend(_e229, _e230, _e231, _e232);
                                        }
                                    }
                                }
                            }
    ...
    let _e233 = gl_GlobalInvocationID_1;
    param_16_6 = _e233.xy;
    let _e236 = registers;
    param_17_4 = _e236.fb_width;
    let _e239 = registers;
    param_18_3 = _e239.fb_height;
    let _e242 = registers;
    param_19_3 = _e242.fb_addr_index;
    let _e245 = registers;
    param_20_3 = _e245.fb_depth_addr_index;
    let _e249 = param_17_4;
    let _e250 = param_18_3;
    let _e251 = param_19_3;
    let _e252 = param_20_3;
    finish_tile((&param_16_6), _e249, _e250, _e251, _e252);
    return;
}
