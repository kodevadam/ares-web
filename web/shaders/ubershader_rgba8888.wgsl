...
fn load_vram_color(index: ptr<function, u32>, slice: u32) {
    ...
    let _e74 = (*index);
    let _e75 = slice_1;
    (*index) = (_e74 + (_e75 * 2097152u));
    let _e79 = (*index);
    let _e82 = vram16_.data[_e79];
    word = _e82;
    let _e84 = word;
    current_color = vec4<i32>(((vec4(_e84) >> vec4<u32>(24u, 16u, 8u, 0u)) & vec4(255u)));
    return;
}
...
fn decode_memory_color(image_read_en: bool) -> vec4<i32> {
    ...
    color_6 = _e79.xyz;
    let _e82 = color_6;
    let _e83 = memory_coverage;
    return vec4<i32>(_e82.x, _e82.y, _e82.z, _e83);
}
...
fn fill_color(col_2: u32) {
    ...
    let _e98 = b_2;
    let _e100 = a_2;
    param_21 = vec4<i32>(i32(_e94), i32(_e96), i32(_e98), i32(_e100));
    let _e104 = param_21;
    write_color(_e104);
    return;
}
...
fn store_vram_color(index_30: ptr<function, u32>, slice_5: u32) {
    ...
    if _e71 {
        {
            let _e72 = (*index_30);
            (*index_30) = (_e72 & 2097151u);
            let _e75 = (*index_30);
            let _e76 = slice_6;
            (*index_30) = (_e75 + (_e76 * 2097152u));
            ...
            let _e92 = col_4;
            let _e97 = col_4;
            word_19 = ((((_e83.x << 24u) | (_e87.y << 16u)) | (_e92.z << 8u)) | (_e97.w << 0u));
            let _e103 = (*index_30);
            let _e106 = word_19;
            vram16_.data[_e103] = _e106;
            let _e108 = (*index_30);
            let _e112 = current_color;
            hidden_vram.data[(2u * _e108)] = (u32((u32((_e112.y & 1i)) & 255u)) * 3u);
            let _e124 = (*index_30);
            let _e130 = current_color;
            hidden_vram.data[((2u * _e124) + 1u)] = (u32((u32((_e130.w & 1i)) & 255u)) * 3u);
            return;
        }
    } else {
        return;
...
fn finish_tile(coord_3: ptr<function, vec2<u32>>, fb_width_2: u32, fb_height_2: u32, fb_addr_index_2: u32, fb_depth_addr_index_2: u32) {
    ...
    store_vram_color((&param_22), _e124);
...
fn main_1() {
    ...
    let _e125 = param_4_8;
    init_tile((&param_23), _e122, _e123, _e124, _e125);
    loop {
